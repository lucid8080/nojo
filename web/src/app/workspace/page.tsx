...
import { NojoWorkspaceAgentDetailsProvider } from "@/components/team/AgentDetailsSheetProvider";
...
export default async function WorkspacePage() {
  return (
    <NojoWorkspaceAgentDetailsProvider>
      <div className="flex h-[100dvh] max-h-[100dvh] min-h-0 flex-col overflow-hidden bg-gradient-to-b from-neutral-100 via-neutral-50 to-sky-50/20 text-slate-900 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900 dark:text-neutral-50">
        <TopNav items={headerNavItems} />

        <main
          className="mx-auto flex h-full min-h-0 w-full max-w-[100rem] flex-1 flex-col overflow-hidden px-4 pb-4 pt-6 sm:px-6 lg:px-8 lg:pb-6 lg:pt-8"
        >
