    ...
    >
      <header className="shrink-0 space-y-3 border-b border-neutral-100 px-5 py-4 dark:border-slate-700/80">
        ...
        <div className="flex flex-wrap items-center gap-3 text-xs">
          ...
          {job.startedAgo ? (
            <span className="text-slate-500 dark:text-neutral-500">Started {job.startedAgo}</span>
          ) : null}
        </div>
        <div>
          ...
          <AgentAvatarGroup agents={job.agents} max={5} />
        </div>
      </header>
      ...
      <footer className="shrink-0 space-y-2 border-t border-neutral-100 bg-neutral-50/50 px-5 py-4 dark:border-slate-700/80 dark:bg-slate-900/80">
        ...
        <div className="grid grid-cols-2 gap-x-3 gap-y-1 text-xs">
          ...
          <span className="text-slate-500 dark:text-neutral-500">Tokens / tools</span>
          <span className="font-medium text-slate-800 dark:text-neutral-200">{job.footer.tokensTools}</span>
