...
export function IntegrationTile({ integration }: { integration: Integration }) {
  return (
    <button
      type="button"
      className="flex w-full aspect-square flex-col items-center justify-center gap-1.5 rounded-2xl border border-neutral-200/60 bg-white/90 p-3 text-center shadow-sm transition hover:border-neutral-300 hover:shadow-md dark:border-slate-700/60 dark:bg-slate-900/60 dark:shadow-black/20 dark:hover:border-slate-600"
    >
